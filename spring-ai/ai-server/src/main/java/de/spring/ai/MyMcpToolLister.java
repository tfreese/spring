 ...
 */
@Component
public class MyMcpToolLister implements CommandLineRunner {
    private static final Logger LOGGER = LoggerFactory.getLogger(MyMcpToolLister.class);

    private final List<McpSyncClient> mcpClients;

    public MyMcpToolLister(final List<McpSyncClient> mcpClients) {
        super();
    ...
    public void run(final String... args) throws Exception {
        ...
        for (McpSyncClient client : mcpClients) {
            ...
            final ToolCallbackProvider provider = SyncMcpToolCallbackProvider.builder().mcpClients(client).build();
