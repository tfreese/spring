...
/**
 * In Grafana können die Metriken über den Prometheus Job-Namen (z.B. "job_name: 'spring-actuator'") gefiltert/ausgelesen werden.
 *
...
public class PrometheusMetricsConfig {
    ...
    //    @Bean
    //    MeterRegistryCustomizer<MeterRegistry> metricsConfig(@Value("${info.app.name}") String appName)
    //    {
    //        return registry ->
    //        {
