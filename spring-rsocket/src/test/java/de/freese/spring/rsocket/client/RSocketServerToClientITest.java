...
class RSocketServerToClientITest
{
    /**
     * @author Thomas Freese
     */
    private static class ClientHandler
    {
        ...
        public Publisher<String> statusUpdate(final String status)
        {
            ...
            return Mono.delay(Duration.ofSeconds(5)).map(index -> String.valueOf(Runtime.getRuntime().freeMemory()));
        }
    }
    ...
    *
    */
    private static final Logger LOGGER = LoggerFactory.getLogger(RSocketServerToClientITest.class);
