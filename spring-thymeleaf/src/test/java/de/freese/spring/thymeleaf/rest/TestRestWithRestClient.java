 ...
 */
@ActiveProfiles("test")
class TestRestWithRestClient extends AbstractRestTestCase {
    @Resource
    ...
    void testPost() {
        ...
        final Person[] personArray = restClient.get().uri("/rest/person/personList").retrieve().toEntity(Person[].class).getBody();
