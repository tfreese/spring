...
public class TestRestWithJreHttpClient implements RestTestCase
{
    ...
    */
    ...
    /**
     * @return {@link jdk.incubator.http.HttpClient.Builder}
     */
    ...
    public void test000HealthEndpoint() throws Exception
    {
        ...
        HttpResponse<String> response = httpClient.send(request, BodyHandler.asString());
    ...
    public void test040PostWithWrongRole() throws Exception
    {
        ...
        HttpRequest request = HttpRequest.newBuilder()
                ...
                .POST(BodyPublisher.fromString("{\"firstName\":\"Thomas\",\"lastName\":\"Freese\"}", StandardCharsets.UTF_8))
                .build()
                ;
        // @formatter:on
    ...
    public void test041Post() throws Exception
    {
        ...
        response = httpClient.send(request, BodyHandler.asString());
