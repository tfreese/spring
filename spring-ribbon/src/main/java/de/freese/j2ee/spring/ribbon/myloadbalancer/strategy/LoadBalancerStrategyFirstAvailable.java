// Created: 21.03.2018
package de.freese.j2ee.spring.ribbon.myloadbalancer.strategy;
...
public class LoadBalancerStrategyFirstAvailable implements LoadBalancerStrategy
{
    ...
    /**
     * @see de.freese.j2ee.spring.ribbon.myloadbalancer.strategy.LoadBalancerStrategy#chooseServer(java.util.List, java.lang.String)
     */
    @Override
