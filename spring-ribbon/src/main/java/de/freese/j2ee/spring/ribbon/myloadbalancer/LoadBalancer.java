// Created: 21.03.2018
package de.freese.j2ee.spring.ribbon.myloadbalancer;
...
import de.freese.j2ee.spring.ribbon.myloadbalancer.ping.LoadBalancerPing;
import de.freese.j2ee.spring.ribbon.myloadbalancer.ping.LoadBalancerPingNoOp;
import de.freese.j2ee.spring.ribbon.myloadbalancer.strategy.LoadBalancerStrategy;
import de.freese.j2ee.spring.ribbon.myloadbalancer.strategy.LoadBalancerStrategyRoundRobin;
...
public class LoadBalancer implements LoadBalancerPing
{
    ...
    private class Pinger extends TimerTask
    {
         ...
         * @return {@link List}
         */
        private List<String> pingSequentiell(final List<String> allServers)
        {
         ...
         * @return {@link List}
         */
        private List<String> pingWithCompletableFuture(final List<String> allServers)
        {
            List<String> workingServers = new ArrayList<>();
         ...
         * @return {@link List}
         */
        private List<String> pingWithCompletionService(final List<String> allServers)
        {
            List<String> workingServers = new ArrayList<>();
         ...
         * @return {@link List}
         */
        private List<String> pingWithStreams(final List<String> allServers)
        {
            // @formatter:off
