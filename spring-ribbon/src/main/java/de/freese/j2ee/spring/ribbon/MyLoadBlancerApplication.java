...
import de.freese.j2ee.spring.ribbon.myloadbalancer.LoadBalancer;
import de.freese.j2ee.spring.ribbon.myloadbalancer.LoadBalancerInterceptor;
import de.freese.j2ee.spring.ribbon.myloadbalancer.ping.LoadBalancerPingUrl;
 ...
 */
public class MyLoadBlancerApplication // implements RestTemplateCustomizer
{
    /**
     *
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(MyLoadBlancerApplication.class);
    ...
    {
        // @formatter:off
        try (ConfigurableApplicationContext context = new SpringApplicationBuilder(MyLoadBlancerApplication.class)
