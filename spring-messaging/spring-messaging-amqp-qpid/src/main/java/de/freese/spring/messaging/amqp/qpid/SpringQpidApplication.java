...
public class SpringQpidApplication {
    ...
    //
    // @Bean
    // public MessageListenerContainer myMessageListenerContainer(final ConnectionFactory connectionFactory, final MessageListenerAdapter myMessageListenerAdapter) {
